...
const SideBar = () => {
  return (
    <div className=" hidden lg:flex fixed md:flex flex-col top-12 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
      <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul className="flex flex-col py-6 px-6 space-y-8">
          ...
          <div className="flex  items-center  pr-4 pl-2 py-2 rounded">
              <IoHome size={22} />
              <span className="ml-2 text-lg tracking-wide truncate">Settings button</span>
            </div>
          </li>
